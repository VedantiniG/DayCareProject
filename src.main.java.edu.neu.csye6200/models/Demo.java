...
public class Demo {
    ...
    public void run(){
      ...
      //  Path relativePathToDumpFile = Paths.get("src/Resources/Students.csv");        
        ...
        Path teacherPathToDumpFile = Paths.get("", "src","main","java","edu","neu","csye6200","Resources", "Teachers.csv");
        ...
        schoolInstance.viewTeacherInformation();
                ...
                Path relativePathToDumpFile = Paths.get("",  "src","main","java","edu","neu","csye6200", "Resources", "Students.csv");
