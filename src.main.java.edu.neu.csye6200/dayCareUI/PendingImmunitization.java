...
public class PendingImmunitization extends javax.swing.JPanel {
    ...
    public PendingImmunitization() {
        ...
        for (ClassRoom tk : this.instance.getClassRooms()){
            classList.add(String.valueOf(tk.getAgeGroup()));
        }
        ...
        for (Teacher tk : this.instance.teachers){
            teacherList.add(String.valueOf(tk.getName()));
        }
    ...
    private void initComponents() {
        ...
        jTblPendingStudents.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Name", "Student Id", "Vaccine1st Dose", "Vaccine 2nd Dose"
            }
        ));
    ...
    private void jbtnVaccineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnVaccineActionPerformed
        ...
        for(ClassRoom cl : classroomList){
            if(cl.getAgeGroup().equals(jComboClassRoom.getSelectedItem().toString())){
                System.out.println("Inside Match of classname");
                String teacherName = jComboTeacher.getSelectedItem().toString();
                if(teacherName!=null){
                    this.populateTable(cl.getStudentTeacherGroup().get(teacherName));

                }
//                for(Teacher tk : teacherList){
//                    if(teacherName == Integer.parseInt(teacherId)){
//                        this.populateTable(cl.getStudentTeacherGroup().get(tk.getName()));
//                    }
//                }
